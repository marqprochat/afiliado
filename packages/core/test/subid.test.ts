...
describe('generateSubId', () => {
  ...
  it('substitui tokens', () => {
    expect(generateSubId('{yyyyMMdd}-{batchId}', { now, batchId: 'ckx1' })).toBe('20260914ckx1');
  });
  ...
  it('só usa caracteres aceitos pela Shopee (letras e números, sem hífen/underscore)', () => {
