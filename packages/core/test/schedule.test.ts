...
describe('scheduleBatch', () => {
  ...
  it('janela que cruza meia-noite: continua após 00:00 e pula o período fechado', () => {
    const night = { ...w, startTime: '22:00', endTime: '02:00' };
    const { runAt } = scheduleBatch(3, 90, night, sp('2026-09-14T23:00:00'));
    expect(runAt).toEqual([
      sp('2026-09-14T23:00:00'),
      sp('2026-09-15T00:30:00'),
      sp('2026-09-15T22:00:00'),
    ]);
  });
});
